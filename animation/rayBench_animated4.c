...
struct point CanvasToViewport(int x, int y){
	struct point i;
	i.x = (float)x * 1.0 / 854.0; i.y = (float)y * 0.6 / (float)480.0; i.z = (float)1.0;
...
void save(struct color canvas[854][480], int id){ //pass in array in C
	char filename[50];
